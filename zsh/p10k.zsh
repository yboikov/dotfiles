...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*api-wm-ibit-services*'  IBITSVC    # These values are examples that are unlikely
      '*api-wm-arc-runners*'  ARCRUNNERS    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_ARCRUNNERS_FOREGROUND=128
  ...
  POWERLEVEL9K_KUBECONTEXT_ARCRUNNERS_CONTENT_EXPANSION+='/wm-arc-runners-01/${P9K_KUBECONTEXT_USER%%/*}'
  ...
  POWERLEVEL9K_KUBECONTEXT_IBITSVC_CONTENT_EXPANSION+='/wm-ibit-services/${P9K_KUBECONTEXT_USER%%/*}'
