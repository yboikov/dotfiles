# Generated by Powerlevel10k configuration wizard on 2025-08-29 at 15:27 EEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*wm-ibit-services*'  IBITSVC    # These values are examples that are unlikely
      '*wm-arc-runners*'  ARCRUNNERS    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_IBITSVC_FOREGROUND=66
  typeset -g POWERLEVEL9K_KUBECONTEXT_ARCRUNNERS_FOREGROUND=76
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=86
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_IBITSVC_CONTENT_EXPANSION=
  POWERLEVEL9K_KUBECONTEXT_IBITSVC_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_NAMESPACE}'
  POWERLEVEL9K_KUBECONTEXT_IBITSVC_CONTENT_EXPANSION+='/${P9K_KUBECONTEXT_CLUSTER}'
  # POWERLEVEL9K_KUBECONTEXT_IBITSVC_CONTENT_EXPANSION+='/${P9K_KUBECONTEXT_USER%%/*}'

  typeset -g POWERLEVEL9K_KUBECONTEXT_ARCRUNNERS_CONTENT_EXPANSION=
  POWERLEVEL9K_KUBECONTEXT_ARCRUNNERS_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_NAMESPACE}'
  POWERLEVEL9K_KUBECONTEXT_ARCRUNNERS_CONTENT_EXPANSION+='/${P9K_KUBECONTEXT_CLUSTER}'
  # POWERLEVEL9K_KUBECONTEXT_ARCRUNNERS_CONTENT_EXPANSION+='/${P9K_KUBECONTEXT_USER%%/*}'
  ...
  # POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='/${P9K_KUBECONTEXT_USER%%/*}'
